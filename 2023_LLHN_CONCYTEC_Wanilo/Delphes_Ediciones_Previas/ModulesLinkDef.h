...
/** \class
 *
 *  Lists classes to be included in cint dictionary
 *
...
#include "modules/IsolationMuon.h" // Added for IsolationMuon
...
#pragma link C++ class IsolationMuon+; // Added for IsolationMuon
