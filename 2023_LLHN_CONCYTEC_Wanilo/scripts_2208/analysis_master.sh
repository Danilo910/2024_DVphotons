...
#python 03_extracting_root_debbug.py
...
echo "04 bins after Delphes_CristianvsWanilo"
python 04_bins_after_Delphes_CristianvsWanilo.py "$1"
python comparacion_muon_simple2.py
python comparacion_muon_MET.py
python comparacion_muon_deltaR.py
