...
destiny = f"./data/graphs_compare_pt/"
...
plot_normalized_histogram(dataframes_electrons[0], dataframes_electrons[1], 'pt', f'Most Energetic Electrons_4', f'Most Energetic Electron_5', 
                          'Transverse Momentum (pt)', 'Probability Density', destiny, f'comparison_e_4vs5.png')

plot_normalized_histogram(dataframes_electrons[1], dataframes_electrons[2], 'pt', f'Most Energetic Electrons_5', f'Most Energetic Electron_6', 
                          'Transverse Momentum (pt)', 'Probability Density', destiny, f'comparison_e_5vs6.png') 

plot_normalized_histogram(dataframes_electrons[0], dataframes_electrons[2], 'pt', f'Most Energetic Electrons_4', f'Most Energetic Electron_6', 
                          'Transverse Momentum (pt)', 'Probability Density', destiny, f'comparison_e_4vs6.png')

plot_normalized_histogram(dataframes_muons[0], dataframes_muons[1], 'pt', f'Most Energetic Muons_4', f'Most Energetic Muon_5', 
                          'Transverse Momentum (pt)', 'Probability Density', destiny, f'comparison_m_4vs5.png')

plot_normalized_histogram(dataframes_muons[1], dataframes_muons[2], 'pt', f'Most Energetic Muons_5', f'Most Energetic Muon_6', 
                          'Transverse Momentum (pt)', 'Probability Density', destiny, f'comparison_m_5vs6.png') 

plot_normalized_histogram(dataframes_muons[0], dataframes_muons[2], 'pt', f'Most Energetic Muons_4', f'Most Energetic Muon_6', 
                          'Transverse Momentum (pt)', 'Probability Density', destiny, f'comparison_m_4vs6.png')
