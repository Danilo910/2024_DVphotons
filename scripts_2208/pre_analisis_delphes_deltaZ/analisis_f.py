    ...
    for sentence in hepmc:     
        ...
        if len(line) > 0:
            ...
            if line[0] == 'E':
                ...
                #con esto nos aseguramos que el dictionario no sea vacio (pt_dict es true si no es vacio)
                ...
                #    max_value_vector = pt_dict[max_key]
                    ...
                    #hacemos esto porque como hemos definido el vector tenemos
                    #[[1545.1365959792824, 1653.2012168126387, 0.7164448122134903, 0.7164448122140824, -5.650767050642604e-07, -5.650767050642604e-07]]
                ...
                if(iterator_Event%1000 == 0):
                    print("evento numero: ", iterator_Event)
                ...
                if(es_foton_final):
                    ...
                    if (realizar_analisis_cumple): #Si es que la particula es foton y es particula final (si no es negativo)    
                        ...
                        try:                                                         
                            ...
                            #sys.exit("salimos")
                            #pt_dict[pt].append([R1,R2, eta1, eta2, zsimpl_value, zcrisitan, z_atlas_value])
                            # Create a vector (list) with the variables
                            vector = [R1, R2, eta1, eta2, zsimpl_value, zcrist, z_atlas_value]

                            # Convert the vector to a string with space-separated values
                            result_string = ' '.join(map(str, vector))
