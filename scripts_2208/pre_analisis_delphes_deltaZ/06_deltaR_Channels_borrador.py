...
def number_displaced(df_photons, df_leptons, deltaR_min_Exponent):
    ...
    number_displaced = 0
    delta_r_min = (10 ** (-deltaR_min_Exponent))*3
...
for mode in modes:
    ...
    for alpha in [4, 5, 6]:
        ...
        for type in ['ZH', 'WH', 'TTH']:
            ...
            # Calculate ΔR a
            deltaR_ph_elec = number_displaced(photons, electrons, 0)

            #print(f"para alpha y canal:{alpha}_{type}: " )
