...
#todo Aca no se recibe un csv file, solo se crea analiticamente la curva
#todo Estos valores no son los mismos brindados por la curva del ploteo.

#Comentamos valores de Cristian y usamos los actualizados del paper
# p0_h = 1.962
# p1_h = 0.262
...
def main(variables):
    ...
    #valores obtenidos de cross_section.dat
    # ZH_M9_Alpha4_13     0.025761
    # ZH_M9_Alpha5_13     0.025753
    # ZH_M9_Alpha6_13     0.025821
    # WH_M9_Alpha4_13     0.188250
    # WH_M9_Alpha5_13     0.189070
    # WH_M9_Alpha6_13     0.188810
    # TTH_M9_Alpha4_13    0.439278
    # TTH_M9_Alpha5_13    0.441155
    # TTH_M9_Alpha6_13    0.441229

    # print("Imprimimos numero de eventos") #Usualmente 10000 para nuestras simulaciones
    # print(n_events)
    # print("Imprimimos scales")
    # print(scales)
    # print("Imprimimos scales type baseout")
    # print(scales[type + '_' + base_out])
    # print("Imprimimos scale")
    # print(scale)
    ...
    #print("Printeamos Jets antes de la conversion")
    #print(jets)

    jets['Constituents'] = jets['Constituents'].apply(convert_single_element_arrays)

    #print("Printeamos Jets despues de la conversion")
    #print(jets)
    

    number_total_jets = len(jets)
    print ("Number of total jets")
    print(number_total_jets)


    numberJets_one_muon = len(jets[jets.Constituents == 13])
    ...
    #todo quiero imprimir el numero de eventos con jets numberEventMuon = 
    ...
    #se bota a los jets y se da preferencia a los muones
    ...
    #Conservo los leptones que tengan el pt=0 sean muones, es decir, la mascara asigna valores distintos de 0 solo a los que no son overlap
    leptons = leptons[(leptons.pdg==13)|(leptons['el_iso_ph']==0)]
    #print('3')
    #print(leptons)

    #!Esto es el overlap remover. Se refiere a objetos que son reconstruidos como dos particulas distintas.
    #! Se refiere a particulas que son reconstruidos como dos ojetos distintas.
    #! Overlapping 
    ...
    #todo Ingresar el codigo de preferencia de muones si desea incluirse en mitad del codigo.
