...
#run_mode = 2 
#LAPTOP: Descomentar sed -i 's+run_mode = 2+run_mode = 2+' ${madgraph_folder}/input/mg5_configuration.txt
...
#el codigo de la siguiente linea hace tambien la funcion de bash hepmc_dist.sh "$madgraph_folder" "$destiny_folder"
#por ello bash hepmc_dist.sh "$madgraph_folder" "$destiny_folder" es comentado
